    ...
    public partial class InitialSchema : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CoupleInvites", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MediaObjectKey = table.Column<string>(type: "text", nullable: true),
                    MediaMimeType = table.Column<string>(type: "text", nullable: true),
                    MediaDurationMs = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CoupleInvites_Code",
                table: "CoupleInvites",
                column: "Code",
                unique: true,
                filter: "\"ConsumedByUserId\" IS NULL");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LocationPoints_CoupleId_ReceivedAt",
                table: "LocationPoints",
                columns: new[] { "CoupleId", "ReceivedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_LocationPoints_Position",
                table: "LocationPoints",
                column: "Position")
                .Annotation("Npgsql:IndexMethod", "GIST");

            migrationBuilder.CreateIndex(
                name: "IX_LocationPoints_UserId_RecordedAt",
                table: "LocationPoints",
                columns: new[] { "UserId", "RecordedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_Messages_CoupleId_CreatedAt",
                table: "Messages",
                columns: new[] { "CoupleId", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_Messages_CoupleId_ServerReceivedAt",
                table: "Messages",
                columns: new[] { "CoupleId", "ServerReceivedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_OutboxEvents_DispatchedAt",
                table: "OutboxEvents",
                column: "DispatchedAt");
        }
